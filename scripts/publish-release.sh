...
bundles=('filecoin-Linux.tar.gz' 'filecoin-Darwin.tar.gz' "filecoin-proof-params-large-sectors-$CIRCLE_TAG.tar.gz" "filecoin-proof-params-small-sectors-$CIRCLE_TAG.tar.gz")
